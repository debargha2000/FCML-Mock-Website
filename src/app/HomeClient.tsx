    ...
    <div>
      ...
      <section ref={heroRef} className="relative h-[100svh] min-h-[640px] w-full overflow-hidden">
        ...
        >
          <div className="flex items-start justify-between">
            ...
            >
              <svg width="40" height="40" viewBox="0 0 40 40" fill="none" className="text-paper/70">
                <circle cx="20" cy="20" r="19" stroke="currentColor" strokeWidth="1" strokeDasharray="4 4" />
                <path d="M20 10v20M10 20h20" stroke="currentColor" strokeWidth="1" />
              </svg>
            </motion.div>
          </div>

          <div className="max-w-4xl">
            <h1 className="font-display text-[12vw] font-light leading-[0.9] text-paper md:text-[8vw]">
              <SplitLines text={"Spaces\nReimagined."} delay={0.5} />
            </h1>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.9, duration: 1, ease }}
              className="mt-8 max-w-md text-base leading-relaxed text-paper/80 md:mt-12 md:text-lg"
            >
              For over two decades, we have been a force in luxury interiors —
              uniting architectural precision with sensual materials.
            </motion.p>
          </div>
        </motion.div>
      </section>
      ...
      <SectionShell className="py-24 md:py-40">
        <div className="grid gap-12 lg:grid-cols-2">
          <div>
            <Reveal>
              <Kicker>The Pioneer of Luxury</Kicker>
            </Reveal>
          </div>
          <div>
            <Reveal>
              <h2 className="font-display text-3xl font-light leading-tight text-ink md:text-5xl md:leading-[1.15]">
                Creating visually stimulating environments where clients can experience our products and make inspired, informed choices.
              </h2>
            </Reveal>
            <Reveal delay={0.1}>
              <div className="mt-12">
                <ArrowLink href="/about">Discover our ethos</ArrowLink>
              </div>
            </Reveal>
          </div>
        </div>
      ...
      <section className="relative my-28 md:my-40">
        <div className="mx-auto grid max-w-[1500px] gap-8 px-6 md:px-10 lg:grid-cols-2 lg:px-16">
          <div className="relative h-[60vh] min-h-[420px] overflow-hidden">
            <Parallax src={IMAGES.homeCollab} alt="Designer surface collaboration" ratio={0.12} className="h-full w-full" />
          ...
          <div className="flex flex-col justify-center">
            ...
            <Reveal delay={0.35} className="mt-10">
              <ArrowLink href="/division/surfaces">
                Explore Surfaces
              </ArrowLink>
            </Reveal>
          </div>
      ...
      <SectionShell className="py-28 md:py-40">
        <div className="grid gap-14 lg:grid-cols-2 lg:items-center">
            <div className="relative aspect-[4/5] w-full max-w-sm overflow-hidden lg:h-[80vh] lg:max-w-none">
              <ImageReveal
                src={IMAGES.homePhilosophy}
...
function DivisionRow({
  ...
  return (
    ...
    >
      <button
        onClick={() => router.push(`/division/${slug}`)}
        data-cursor="view"
