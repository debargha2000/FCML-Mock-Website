    ...
    <div>
      ...
      <section ref={heroRef} className="relative h-[85svh] min-h-[520px] overflow-hidden">
        <motion.div style={{ y }} className="absolute inset-0">
          <img src={IMAGES.aboutHero} alt="FCML architecture" className="kenburns h-full w-full object-cover" />
      ...
      <SectionShell className="pb-10">
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16">
          <div className="relative aspect-[4/5] overflow-hidden lg:sticky lg:top-28 lg:h-[80vh]">
            <ImageReveal src={IMAGES.aboutNarrative} alt="FCML showroom" className="h-full w-full" />
          </div>
      ...
      <SectionShell className="py-12 md:py-20">
        <div className="grid gap-px overflow-hidden border border-ink/10 bg-ink/10 md:grid-cols-3">
          {[
            { tag: "Vision", body: ABOUT.vision, img: ABOUT.images.vision },
            { tag: "Mission", body: ABOUT.mission, img: ABOUT.images.mission },
            { tag: "Motto", body: ABOUT.motto, img: ABOUT.images.motto },
          ].map((c, i) => (
            <motion.div
              key={c.tag}
      ...
      <section className="relative my-24 h-[60vh] min-h-[380px] overflow-hidden md:my-32">
        <Parallax src={IMAGES.aboutParallax} alt="" ratio={0.15} className="absolute inset-0 h-full w-full" />
